...
- A **Multi-Layer Percentron (MLP) Regression** algorithm
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Multi-Layer Percentron (MLP) Regression classifier model.
...
```json
{
  "status": "success",
  "message": "",
  "timestamp": "2023-09-07T17:14:20.926405",
  "requestId": "8de91dae3c",
  "targetDescription": "Target variable",
  "predictions": [
    {
      "sampleId": "C14AN3",
